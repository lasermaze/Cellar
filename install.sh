...
printf "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
printf "\n"
printf "  ${BOLD}Step 1:${RESET} Activate cellar in this terminal\n"
printf "\n"
printf "    source %s\n" "$RC"
printf "\n"
printf "  ${BOLD}Step 2:${RESET} Set up an AI API key (pick one)\n"
printf "\n"
printf "    export ANTHROPIC_API_KEY=\"sk-ant-...\"   ${BOLD}# Claude — https://console.anthropic.com${RESET}\n"
printf "    export DEEPSEEK_API_KEY=\"sk-...\"        ${BOLD}# DeepSeek — https://platform.deepseek.com${RESET}\n"
printf "    export KIMI_API_KEY=\"sk-...\"            ${BOLD}# Kimi — https://platform.moonshot.ai${RESET}\n"
printf "\n"
printf "    Or set it in the web UI (Step 4 → Settings).\n"
printf "\n"
printf "  ${BOLD}Step 3:${RESET} Install Wine (one-time setup)\n"
printf "\n"
printf "    cellar\n"
printf "\n"
printf "    This checks dependencies and walks you through\n"
printf "    installing Homebrew and Wine if needed.\n"
printf "\n"
printf "  ${BOLD}Step 4:${RESET} Open the web UI\n"
printf "\n"
printf "    cellar serve\n"
printf "\n"
printf "    Opens your browser. Add games, launch with AI,\n"
printf "    and configure settings — all from the UI.\n"
printf "\n"
printf "  ${BOLD}Or use the CLI:${RESET}\n"
printf "\n"
printf "    cellar add game.exe    Add a game\n"
printf "    cellar add game.iso    Add from disc image\n"
printf "    cellar launch game     Launch with AI agent\n"
printf "\n"
